...
INSERT INTO "reportes_new" (
  id, fecha_reportada, comunidad_id, tipo_reporte, cliente_id, prospecto_id,
...
CREATE TABLE "reportes_seguimiento_new" (
  ...
  "estado" TEXT NOT NULL CHECK ("estado" IN ('ASIGNADO','EN_PROCESO','PENDIENTE_CONFIRMACION','NO_LOCALIZADO','COMPLETADO','CANCELADO')),
  "comentario" TEXT NOT NULL,
