...
ALTER TABLE instalaciones_fibra RENAME TO instalaciones_fibra_old_terminal_caja;

CREATE TABLE instalaciones_fibra (
...
INSERT INTO instalaciones_fibra (
  ...
  titular_telefono, titular_direccion, titular_referencia, foto_router_r2_key, foto_router_content_type
)
SELECT
  id, reporte_id, prospecto_id, cliente_id, servicio_fibra_id, comunidad_id, tecnico_id,
  fibra_optica_metros, tensor_gancho, argollas, taquetes, sujetadores, roseta,
  ...
  alfanumerico_equipo, titular_nombres, titular_apellido_paterno, titular_apellido_materno,
  titular_telefono, titular_direccion, titular_referencia, foto_router_r2_key, foto_router_content_type
FROM instalaciones_fibra_old_terminal_caja;

DROP TABLE instalaciones_fibra_old_terminal_caja;
